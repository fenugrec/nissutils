...
// shorter version found with 705513 version ? (8U92A, 
...
static Structures_0(id) {
	...
	id = AddStrucEx(-1,"ID3_short",0);
	
	id = GetStrucIdByName("ID3_short");
	...
	AddStrucMember(id,"pRAMinit?",	0X7A,	0x20500400,	0X0,	4);
	AddStrucMember(id,"pRAM_unk2",	0X7E,	0x20500400,	0X0,	16);
	AddStrucMember(id,"pISR_IMI3A",	0X8E,	0x20500400,	0X0,	4);
	AddStrucMember(id,"pTHIS",	0X92,	0x20500400,	0X0,	4);
	AddStrucMember(id,"pIVECT2",	0X96,	0x20500400,	0X0,	4);
